...
Please note that this script was written in a way that adapted to the author's computer setup; please modify it wherever necessary. Some parts of the codes were hidden with "%" for two reasons: 1. analysis method that was replaced and 2. temporary exclusion to prevent repetitive pop-ups each time tested.
